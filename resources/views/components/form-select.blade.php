...
@php
    $baseClasses =
        'w-full border text-sm rounded-xl block py-2.5 px-4 bg-white disabled:shadow-none shadow-xs focus:shadow-lg text-neutral-700 disabled:text-neutral-400 outline-none focus:border-neutral-900 focus:ring-2 focus:ring-neutral-900/40 transition-colors duration-300';
