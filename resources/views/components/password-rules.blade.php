<div class="bg-neutral-100 border border-neutral-200 text-neutral-700 px-4 py-3 rounded-md mb-6">
    <div class="flex justify-between items-center">
        <div class="flex items-center">
            <x-icon name="information-circle" class="w-7 h-7 text-neutral-600 mr-4" />
            <p class="font-bold">Regras para a senha</p>
        </div>
        <button type="button" @click="showRules = !showRules"
            class="text-sm text-neutral-600 hover:underline cursor-pointer flex items-center transition-all">
